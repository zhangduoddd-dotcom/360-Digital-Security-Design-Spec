...
Keywords: index, ai routing, backend design, html demo, vue codegen, ui generation
...
- 生成可演示页面、demo、可点击预览时，默认读取 [06-vue-code/preview-html.md](./06-vue-code/preview-html.md)，并只输出 HTML 文件。
