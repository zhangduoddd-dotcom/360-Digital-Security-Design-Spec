...
Keywords: ai output, checklist, ui generation, backend, ant class, component reuse
...
- [ ] 没有错误使用旧别名 class 作为基础组件，例如 `.btn`、`.btn-primary`、`.form-input`、`.data-table`、`.tag-status`、`.status-tag`、`.pagination`。
...
按以下顺序修正：固定框架、真实组件 class 继承、页面类型、模块结构、业务字段、组件清单、交互状态、Token 与字体、视觉风格、负向约束。