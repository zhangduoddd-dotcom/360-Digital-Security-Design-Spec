...
工作台读 `04-pages/dashboard.md`；列表页读 `04-pages/list-page.md`、`03-interaction/list-search.md`、`03-interaction/list-table.md`；表单页读 `04-pages/form-page.md`、`03-interaction/form-entry.md`；详情页读 `04-pages/detail-page.md` 和页面容器规则；用户管理读列表、表格和表单规则。