...
| 明确说“本地安全大脑 / 本脑 / 基于本脑框架” | `local-security-brain-frame/index.html` |
...
当用户明确提出“本地安全大脑 / 本脑 / 基于本脑框架”时，必须调用：
...
```text
1. 完整复制 local-security-brain-frame/index.html 作为页面底座。
2. 不根据文字描述重新拼装本脑框架。
3. 只替换业务内容、导航文案、菜单数据、页面内容和 mock 数据。
4. 保留 index.html 中的 DOM、CSS、JS、iconfont、hover、active、open、展开收起和响应式交互。
```
